...
MODES = {
    ...
    "cosmetic": {
        ...
        "description": "Убираю междометия, разделяю на абзацы и очищаю текст.",
        "prompt": "Отредактируй текст: убери междометия и слова-паразиты, раздели на абзацы, исправь грамматику. Сохрани эмоции, интонацию и характер автора — текст должен звучать живо, как написанный от руки. Верни только отредактированный текст."
    },
    "notes": {
        "name": "📋 Заметки/сообщения",
        "short": "Заметки/сообщения",
        "description": "Более официальный и ёмкий тон. Подойдёт для отправки сообщения коллеге или текстовой заметки для себя.",
